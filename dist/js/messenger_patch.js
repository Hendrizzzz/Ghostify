(() => {
  ...
  (function() {
    ...
    function isUnreadStateKey(key) {
      return key === "isunread" || key === "unread" || key === "hasunread" || key === "unreadcount" || key === "unreadmessagecount" || key === "unreadmessagescount" || key === "unseencount" || key === "unseenmessagecount" || key === "unseenmessagescount";
    }
    function isReadStateKey(key) {
      return key === "isread" || key === "read" || key === "seen" || key === "seenbyviewer";
    }
    ...
    function isReadStateValue(value) {
      ...
      if (typeof value === "string") {
        const normalized = value.trim().toLowerCase();
        return normalized === "true" || normalized === "1" || normalized === "read" || normalized === "seen";
      }
      return false;
    }
    function isUnreadReadStateValue(value) {
      ...
      if (typeof value === "string") {
        const normalized = value.trim().toLowerCase();
        return normalized === "false" || normalized === "0" || normalized === "unread" || normalized === "";
      }
      return false;
    }
